...
const kTextStyleS15W600CBlack = TextStyle(
  fontSize: 15,
  fontWeight: FontWeight.w600,
  color: Colors.black,
);

const kTextStyleS15W600CWhite = TextStyle(
  fontSize: 15,
  fontWeight: FontWeight.w600,
  color: Colors.white,
);

const kTextStyleS18W600CBlack = TextStyle(
  fontSize: 18,
  fontWeight: FontWeight.w600,
  color: Colors.black,
);

const kTextStyleS15W600CGrey = TextStyle(
  fontSize: 15,
  fontWeight: FontWeight.w600,
  color: Colors.grey,
);

const kTextStyleS15W600CGreen = TextStyle(
  fontSize: 15,
  fontWeight: FontWeight.w600,
  color: Colors.green,
);
...
final kInputBorderNone = OutlineInputBorder(
  ...
  borderSide:
      const BorderSide(width: 1.2, color: Color.fromRGBO(148, 148, 148, 0.37)),
);

final kInputBorderRed = OutlineInputBorder(
  borderRadius: BorderRadius.circular(6),
  borderSide:
      const BorderSide(color: CustomColors.redBorderTextFieldColor, width: 1.2),
);

final kInputBorderBlue = OutlineInputBorder(
  borderRadius: BorderRadius.circular(8),
  borderSide:
      const BorderSide(width: 1.2, color: Color.fromRGBO(72, 13, 250, 0.37)),
);
