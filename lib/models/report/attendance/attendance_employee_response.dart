...
AttendanceEmployeeResponseModel attendanceEmployeeResponseModelFromJson(String str) => AttendanceEmployeeResponseModel.fromJson(json.decode(str));

String attendanceEmployeeResponseModelToJson(AttendanceEmployeeResponseModel data) => json.encode(data.toJson());
