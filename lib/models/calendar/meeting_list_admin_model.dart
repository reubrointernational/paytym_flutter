...
MeetingListAdminModelOLD meetingListAdminModelFromJson(String str) =>
    MeetingListAdminModelOLD.fromJson(json.decode(str));

String meetingListAdminModelToJson(MeetingListAdminModelOLD data) =>
    json.encode(data.toJson());

class MeetingListAdminModelOLD {
  MeetingListAdminModelOLD({
    this.message,
    this.meetingsListe,
  });
  ...
  factory MeetingListAdminModelOLD.fromJson(Map<String, dynamic> json) =>
      MeetingListAdminModelOLD(
