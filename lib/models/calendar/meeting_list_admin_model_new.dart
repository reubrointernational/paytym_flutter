...
// import 'dart:convert';
//
// import '../report/medical_list_admin_model.dart';
//
// MeetingListAdminModelCopy meetingListAdminModelFromJson(String str) =>
//     MeetingListAdminModelCopy.fromJson(json.decode(str));
//
// class MeetingListAdminModelCopy {
// }
//
// String meetingListAdminModelToJson(MeetingListAdminModelCopy data) =>
...
//   User? user;
//   String? agenda;
//   List<MeetingAttendees>? meetingAttendees;
//
...
//       agenda: json["agenda"],
//       meetingAttendees:
//           json[MeetingAttendees.fromJson(json["meeting_attendees"])]);
//
//   Map<String, dynamic> toJson() => {
//         "id": id,
//         "user_id": userId,
...
//   Users? users;
//
//   MeetingAttendees({this.id, this.meetingId, this.attendeeId, this.users});
//
//   MeetingAttendees.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
