...
//                       kSizedBoxW4,
//                       Text(
//                         Get.find<DashboardController>().getNextShiftDate(),
//                         style: kTextStyleS14C255140x3,
//                       ),
//                     ],
//                   ),
...
//                       kSizedBoxW4,
//                       Text(
//                         Get.find<DashboardController>().getNextShift(),
//                         style: kTextStyleS14C255140x3,
//                       ),
//                     ],
//                   ),
                ...
                Row(
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              SliderTheme(
                                ...
                                child: Slider(
                                  ...
                                  inactiveColor: CustomColors.whiteCardColor,
                                  activeColor: CustomColors.whiteCardColor,
                                  value: dashboardController.sliderValue.value,
                                  max: 100,
                                  min: 0,
                                  onChanged: (double value) {
                                    dashboardController.changeSliderPosition(value);
                                  },
                                  onChangeEnd: (double value) =>
                                      dashboardController.sliderController(value),
                                ),
                              ),
                            ],
                          ),
                    ...
                    Obx(
                        ...
                        text:  TextSpan(
                          text:
                          "${(Get.find<DashboardController>().seconds.value/ 60).floor().toString().padLeft(2, '0')}:${dashboardController.seconds.value.remainder(60).toString().padLeft(2, '0')}",
                          style: TextStyle(
                            fontSize: 25,
                            fontWeight: FontWeight.w500,
                            color: CustomColors.whiteTextColor,
                ...
                IntrinsicHeight(
                  child: Row(
                    children: [
                      Obx(
                            () => Text(
                          "$kNowIsString ${dashboardController.time.value}",
                          style: kTextStyleS14C255140x3,
                        ),
                      ),
                      const VerticalDivider(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        kSizedBoxW4,
                        Text(
                          dashboardController.getNextShiftDate(),
                          style: kTextStyleS14C255140x3,
                        ),
                      ],
                    ),
                    Row(
                      children: [
                        ...
                        kSizedBoxW4,
                        Text(
                          dashboardController.getNextShift(),
                          style: kTextStyleS14C255140x3,
                        ),
                      ],
                    ),
